The Go module "github.com/datawire/ambassador-agent" incorporates the
following Free and Open Source software:
    ...
    github.com/argoproj/argo-rollouts                 v1.3.2                                Apache License 2.0
    ...
    github.com/getkin/kin-openapi                     v0.112.0                              MIT license
    ...
    github.com/spf13/cobra                            v1.6.0                                Apache License 2.0
    ...
    go.etcd.io/etcd/api/v3                            v3.5.5                                Apache License 2.0
    ...
    golang.org/x/oauth2                               v0.0.0-20220608161450-d0670ef3b1eb    3-clause BSD license
    ...
    k8s.io/kube-openapi                               v0.0.0-20221012153701-172d655c2280    3-clause BSD license, Apache License 2.0
    k8s.io/kubectl                                    v0.26.0                               Apache License 2.0
    k8s.io/kubernetes                                 v1.26.0                               Apache License 2.0
    k8s.io/metrics                                    v0.26.0                               Apache License 2.0
    k8s.io/utils                                      v0.0.0-20221107191617-1a15be271d1d    3-clause BSD license, Apache License 2.0
